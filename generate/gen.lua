...
-- ZZZ It's generally a bad idea to adjust this except at the same time as
-- ZZZ a major Stellaris patch, because it's used for the component keys + language keys.
-- ZZZ So if you change those, savegame ships will be mangled.
